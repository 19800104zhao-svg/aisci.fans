...
const ICONS = {
  ...
  "git-branch": '<circle cx="6" cy="4" r="2"></circle><circle cx="18" cy="18" r="2"></circle><circle cx="6" cy="20" r="2"></circle><path d="M6 6v12"></path><path d="M8 6h4a6 6 0 0 1 6 6v4"></path>',
  landmark:
  ...
  rocket:
    '<path d="M4.5 16.5c-1.1 1.1-1.6 2.8-1.5 4.5 1.7.1 3.4-.4 4.5-1.5"></path><path d="M9 15 5 11l4.5-4.5C12.2 3.8 15.8 2.4 20 3c.6 4.2-.8 7.8-3.5 10.5L12 18l-3-3Z"></path><path d="M14 6h.01"></path>',
  search: '<circle cx="11" cy="11" r="7"></circle><path d="m20 20-3.5-3.5"></path>',
  send: '<path d="m22 2-7 20-4-9-9-4 20-7Z"></path><path d="M22 2 11 13"></path>',
  "scan-search": '<path d="M7 3H5a2 2 0 0 0-2 2v2"></path><path d="M17 3h2a2 2 0 0 1 2 2v2"></path><path d="M7 21H5a2 2 0 0 1-2-2v-2"></path><path d="M17 21h2a2 2 0 0 0 2-2v-2"></path><circle cx="11" cy="11" r="3"></circle><path d="m16 16-2.2-2.2"></path>',
...
const UI_TEXT = {
  en: {
    ...
    opsAria: "AISci operating loop",
    opsScanTitle: "Scan",
    opsScanBody: "Papers, code, patents, conferences, labs, and startup activity",
    opsMapTitle: "Map",
    opsMapBody: "Problems, bottlenecks, experts, students, data, and funding relationships",
    opsVerifyTitle: "Verify",
    opsVerifyBody: "Use proof-of-work and expert review instead of credential worship",
    opsLaunchTitle: "Launch",
    opsLaunchBody: "Virtual labs, open collaboration, company formation, and capital access",
  ...
  zh: {
    ...
    opsAria: "AISci 运行闭环",
    opsScanTitle: "扫描",
    opsScanBody: "论文、代码、专利、会议、实验室、公司动态",
    opsMapTitle: "建图",
    opsMapBody: "问题、瓶颈、专家、学生、数据和资金关系",
    opsVerifyTitle: "验证",
    opsVerifyBody: "用 proof-of-work 和专家背书替代头衔崇拜",
    opsLaunchTitle: "启动",
    opsLaunchBody: "虚拟实验室、开源协作、公司化与资本连接",
    problemsKicker: "前沿问题",
  ...
  ja: {
    ...
    opsAria: "AISci 運用ループ",
    opsScanTitle: "Scan",
    opsScanBody: "論文、コード、特許、会議、ラボ、企業活動を収集",
    opsMapTitle: "Map",
    opsMapBody: "課題、ボトルネック、専門家、学生、データ、資金関係を接続",
    opsVerifyTitle: "Verify",
    opsVerifyBody: "肩書きではなく proof-of-work と専門家レビューで検証",
    opsLaunchTitle: "Launch",
    opsLaunchBody: "バーチャルラボ、オープン協力、会社化、資本アクセスへ展開",
    problemsKicker: "先端課題",
